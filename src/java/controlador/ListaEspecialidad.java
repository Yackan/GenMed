 ...
 * @author Sulay2016
 */
public class ListaEspecialidad extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            BD_especialidad bd_D = new BD_especialidad();
            ArrayList<VO_Especialidad> personas = bd_D.getPersonas();
            ...
            for (VO_Especialidad persona : personas ) {
