 ...
 * @author Asus-PC
 */
public class AgregarIncripcionFinalTutor extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println(
                    ...
                    + "            <br>\n"
                    + "            <form action=\"AgregarIncripcionFinalTutor.html\" method=\"POST\" class=\"col-md-4 col-md-offset-4\">\n"
                    ...
                    + "\n"
                    + "<div class=\"form-group\">\n"
                    + "<label for=\"number\">identificacion o numero de usuaio del paciente</label>\n"
                    + "<input type=\"number\" class=\"form-control\" name=\"myBtn\" id=\"myBtn\" placeholder=\"Solo se puede llenar si se cumple una condicion\" size=\"40\"  required>\n"
                    + "</div>\n"
                    + "</div> \n"
                    + "<br><br>\n"
                    + "\n"
    ...
    protected void postProcessRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String idPaciente = request.getParameter("myBtn");
        ...
        VO_Tutor TUTOR=new VO_Tutor(a, Apodo, Alergia, contrasenia, Integer.parseInt(idPaciente),Integer.parseInt(numero) , nombre, 
                                    apellido, corrreo, fechaNacimiento, Sangre, condicion);
        BD_Tutor db_tutor=new BD_Tutor();
        db_tutor.addTutor(TUTOR);

        a++;
        response.sendRedirect("ListaTutor.html");
    }
