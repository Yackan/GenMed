 ...
 * @author Asus-PC
 */
public class AgregarTutor extends HttpServlet {
int a=3;
    /**
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println(
                    ...
                    + "            <br>\n"
                    + "            <form action=\"AgregarTutor.html\" method=\"POST\" class=\"col-md-4 col-md-offset-4\">\n"
                    ...
                    + "                <div class=\"form-group\">\n"
                    + "                    <label for=\"CORREOTUTOR\">id del paciente</label>\n"
                    + "                    <input type=\"text\" class=\"form-control\" name=\"txtCorreoTutor\" required>\n"
                    + "                </div>\n"
    ...
    protected void postProcessRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String idPaciente = request.getParameter("Nacimiento");
        String Sangre = request.getParameter("tipo de sangre");
        String condicion = request.getParameter("Paciente Condicion ");
        String CorreoTutor = request.getParameter("txtCorreoTutor");
        VO_Tutor TUTOR=new VO_Tutor(a, contrasenia, Apodo, Alergia, Integer.parseInt(CorreoTutor),  Integer.parseInt(numero), nombre, apellido, corrreo, idPaciente, Sangre, condicion);
