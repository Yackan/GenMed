...
int a=3;
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println(
                    ...
                    + "\n"
                    + "            <h2>Agregar Especalidad de medicina</h2>\n"
                    + "            <br>\n"
                    + "            <form action=\"AgregarEspecialidad.html\" method=\"POST\" class=\"col-md-4 col-md-offset-4\">\n"
    ...
    protected void postProcessRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        VO_Especialidad persona = new VO_Especialidad(a,nombre,apellido);

        BD_especialidad bd = new BD_especialidad();
        bd.addEspecialista(persona);a++;
        response.sendRedirect("ListaEspecialidad.html");
    }
