 ...
 * @author Asus-PC
 */
public class AgregarMedicos extends HttpServlet {
int a=3;
    /**
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println(
                    ...
                    + "            <br>\n"
                    + "            <form action=\"AgregarMedico.html\" method=\"POST\" class=\"col-md-4 col-md-offset-4\">\n"
    ...
    protected void postProcessRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        VO_Medico persona = new VO_Medico(Integer.parseInt(numero),nombre);

        BD_Doctor bd = new BD_Doctor();
        bd.addDoctor(persona);
        a++;
        response.sendRedirect("ListaMedico.html");
    }
