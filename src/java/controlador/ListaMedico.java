...
public class ListaMedico extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            BD_Doctor bd_D = new BD_Doctor();
            ArrayList<VO_Medico> personas = bd_D.getPersonas();
            ...
            content.append("\n"
                    ...
                    + "                    <tr>\n"
                    + "                       <th>id Medico</th>\n"
                    + "                       <th>Cedula o tarjeta profesional</th>\n"
                    + "                        <th>Nombre</th>\n"
                    + "                    </tr>\n"
                    + "                </thead>\n"
                    + "                <tbody>\n");

            for (VO_Medico persona : personas ) {
                int index = personas.indexOf(persona);
                int d=index+1;
                content.append(""
                        + "<tr>\n"
                        + "<td>" + d+ "</td>\n"
                        + "<td>" + persona.getIdMedico()+ "</td>\n"
