 ...
 * @author Asus-PC
 */
public class AgregarPacienteL extends HttpServlet {
int a=3;
    /**
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println(
                    ...
                    + "            <br>\n"
                    + "            <form action=\"AgregarPacienteL.html\" method=\"POST\" class=\"col-md-4 col-md-offset-4\">\n"
    ...
    protected void postProcessRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        VO_PacienteL grado2=new VO_PacienteL(a, contrasenia, Integer.parseInt(numero), Apodo, Alergia, CorreoTutor, Integer.parseInt(numero), nombre, apellido, corrreo, fechaNacimiento, Sangre, condicion);
        ...
        a++;
        response.sendRedirect("ListaPacienteL.html");
    }
